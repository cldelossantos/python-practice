...
# # 1) Write a function called season_teller that takes a number corresponding to a month (1-12) and prints the season that is in effect during that month. If the month observes a season change, print the season that is in effect at the start of the month as well as information about when the season will change. 
